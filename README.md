...
- Hardens the iPhone sheet lock at both document and body level, prevents window-level focus scrolling, and keeps keyboard correction inside the active form sheet.
...
- Keeps dashboard buying-list rows to checkbox and item name only; quantities and actions remain in View All.
...
- Tightens job-sheet spacing, wraps profitability labels safely, and reserves the lower action area from floating accessibility controls.
